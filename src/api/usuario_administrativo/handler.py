...
from .workflows import handle_in_progress_usuario_administrativo
...
async def handle_usuario_administrativo(
    ...
    if current_state == UsuarioAdministrativoState.CONVERSATION_FINISHED:
        ...
        return await handle_in_progress_conversation(
            ...
            in_progress_state=UsuarioAdministrativoState.AWAITING_NECESITY_TYPE,
            interaction_data=interaction_data,
            client=client,
            sheets_service=sheets_service,
            workflow_function=handle_in_progress_usuario_administrativo,
        )
