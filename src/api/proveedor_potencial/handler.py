...
from .workflows import handle_in_progress_proveedor_potencial
...
async def handle_proveedor_potencial(
    ...
    if current_state == ProveedorPotencialState.CONVERSATION_FINISHED:
        ...
        return await handle_in_progress_conversation(
            ...
            in_progress_state=ProveedorPotencialState.AWAITING_SERVICE_TYPE,
            interaction_data=interaction_data,
            client=client,
            sheets_service=sheets_service,
            workflow_function=handle_in_progress_proveedor_potencial,
        )
